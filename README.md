...
<dl>
  <dt>1. sHape2O SMART Painter Prototype</dt>
  <dd>Description: A vanilla (no water required) wire-based variant of the single painter that only paints quadrants of the input that are specified by the wire inputs.</dd>
  <dd>Version: 1.0.0</dd>
